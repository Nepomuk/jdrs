...
/* Provides access to LTC DAC configuration.                  */
/*                                               M.C. Mertens */
/*============================================================*/
...
TMrfData_LTC::TMrfData_LTC(const u_int32_t& blocklength, const u_int32_t& defaultindex, const u_int32_t& defaultstreamoffset, const u_int32_t& defaultvalueoffset, const bool& defaultreverse, const bool& defaultstreamreverse)
...
void TMrfData_LTC::setCommand(const u_int32_t& command)
{
	setLocalItemValue("Command", command);
}

void TMrfData_LTC::setDACValue(const std::string& dac, const u_int32_t& value)
{
	_ltcdacvalues.find(dac)->second.value = value;
}

u_int32_t TMrfData_LTC::getDACValue(const std::string& dac)
{
	return _ltcdacvalues.find(dac)->second.value;
}

void TMrfData_LTC::setDACActivated(const std::string& dac, const u_int32_t& active)
{
	_ltcdacactivated.find(dac)->second.value = active;
}

u_int32_t TMrfData_LTC::getDACActivated(const std::string& dac)
{
	return _ltcdacactivated.find(dac)->second.value;
}

void TMrfData_LTC::assembleDAC(const std::string& dac)
{
...
std::map<std::string, TConfItem>::iterator TMrfData_LTC::getDACIteratorBegin()
{
	return _ltcdacvalues.begin();
}

std::map<std::string, TConfItem>::iterator TMrfData_LTC::getDACIteratorEnd()
{
	return _ltcdacvalues.end();
}

std::map<std::string, TConfItem>::iterator TMrfData_LTC::getDACActivatedIteratorBegin()
{
	return _ltcdacactivated.begin();
}

std::map<std::string, TConfItem>::iterator TMrfData_LTC::getDACActivatedIteratorEnd()
{
	return _ltcdacactivated.end();
}

std::map<std::string, TConfItem>::const_iterator TMrfData_LTC::getConstDACIteratorBegin() const
{
	return _ltcdacvalues.begin();
}

std::map<std::string, TConfItem>::const_iterator TMrfData_LTC::getConstDACIteratorEnd() const
{
	return _ltcdacvalues.end();
}

std::map<std::string, TConfItem>::const_iterator TMrfData_LTC::getConstDACActivatedIteratorBegin() const
{
	return _ltcdacactivated.begin();
}

std::map<std::string, TConfItem>::const_iterator TMrfData_LTC::getConstDACActivatedIteratorEnd() const
{
	return _ltcdacactivated.end();
}

int TMrfData_LTC::getDACCount() const
{
