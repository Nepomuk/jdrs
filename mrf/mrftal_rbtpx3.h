...
namespace tpxctrl_value {
	...
	static const mrf::registertype tpxfakedata = 0x100;		//CM_MODE(8)
        static const mrf::registertype topix3config = 0x200;            //CM_MODE(9)
...
*/
class TMrfTal_RBTopix3: virtual public TMrfTal_RBUDP
{
	public:
                TMrfTal_RBTopix3();
                virtual ~TMrfTal_RBTopix3();
		...
		virtual void triggerRead(const u_int32_t& triggercount, const bool& withlo) const;
                ...
                virtual void configTopixSlowReg(const TMrfData_Tpx3Flags& data) const;
